        ...
        <div>
                ...
                <Image src={getRandomInterviewCover()} alt="cover" width={90} height={90} className="rounded-full object-fit size-[90px]" />
                 ...
                 <div className="flex flex-row gap-5 mt-3">
                    ...
                    <div className="flex flex-row gap-2 items-center">
                        ...
                        <p>{feedback?.scoore || '---'}/100</p>
                    </div>
                 </div>

                 <p className="line-clamp-2 mt-5">
                    {feedback?.finalAssessment || 'Du har inte tagit intervjun än. Ta det nu för att förbättra dina färdigheter.'}
                 </p>
            </div>
            <div className="flex flex-row justify-between">
                ...
                <Button className="btn-primary">
                    <Link href={feedback
                        ? `/intervju/${interviewId}/feedback`
                        : `/intervju/${interviewId}`
                    }>
                        {feedback ? 'Se feedback' : 'Ta intervju'}
                    </Link>
                </Button>
